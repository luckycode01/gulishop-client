          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="saleAttr in spuSaleAttrList" :key='saleAttr.id'>
                ...
                <dd changepirce="0" :class="{'active':saleAttrValue.isChecked === '1'}" @click="changeIsChecked(saleAttrValue,saleAttr.spuSaleAttrValueList)" v-for="saleAttrValue in saleAttr.spuSaleAttrValueList" :key="saleAttrValue.Id">
...
export default {
  ...
  methods: {
    ...
    changeIsChecked(saleAttrValue, spuSaleAttrValueList) {
