    ...
    <div class="main">
      <div class="py-container">
        ...
        <div class="bread">
          ...
          <ul class="fl sui-tag">
            <li class="with-x" v-if="searchParams.categoryName">{{searchParams.categoryName}}<i @click="deleteCateParams">×</i></li>
            ...
            <li class="with-x" v-for="(prop,index) in searchParams.props" :key='index'>{{prop.split(":")[1]}}<i @click="deleteProp(index)">×</i></li>
          </ul>
        </div>
        <!--selector-->
        <SearchSelector @searchByTrade='searchByTrade' @searchByattr='searchByattr' />
        <!--details-->
...
export default {
  ...
  methods: {
    ...
    handleSearchParams() {
      ...
      const searchParams = { ...this.searchParams, categoryName, category1Id, category2Id, category3Id, keyword };
    ...
    searchByattr(attr, attrvalue) {
      ...
      let repead = this.searchParams.props.some((item) => item === prop)
      if (repead) return;
